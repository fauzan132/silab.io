                                        ...
                                        @foreach($data as $row => $value)
                                            <tr>
                                                ...
                                                <form action="{{ route('perusahaan.destroy', $value->id_perusahaan) }}" method="post">
                                                    ...
                                                    <a href="{{ route('perusahaan.show', $value->id_perusahaan) }}" type="button" class="btn btn-sm waves-effect waves-light btn-info"><i class="ti-eye"></i> Detail</a>
                                                    <a href="{{ route('perusahaan.edit', $value->id_perusahaan) }}" type="button" class="btn btn-sm waves-effect waves-light btn-warning"><i class="ti-pencil-alt"></i> Ubah</a>
